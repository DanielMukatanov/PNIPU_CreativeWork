...
int main()
{
	...
	text_font.loadFromFile("ttf/arialmt.ttf");
	...
	Answer.setFillColor(Color::Magenta);
	...
	New.move(Newx, Newy);
	New.setFillColor(Color::Magenta);
	...
	Add.move(Addx, Addy);
	Add.setFillColor(Color::Magenta);
	...
	Del.move(Delx, Dely);
	Del.setFillColor(Color::Magenta);
	...
	DelEdge.setFillColor(Color::Magenta);
	...
	AddEdge.setFillColor(Color::Magenta);
